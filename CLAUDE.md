...
```cmd
cd /d "C:\Users\locumpharmacist\Downloads\appt-main\appt-main\kevappts-cf" && npm install && npm install -D wrangler@latest && npx wrangler d1 execute kevappts-db --remote --file=schema.sql --yes && npx wrangler deploy
```
...
```cmd
cd /d "C:\Users\locumpharmacist\Downloads\appt-main\appt-main\reserve-collect-cf" && npm install && npm install -D wrangler@latest && npx wrangler d1 execute reserve-collect-db --remote --file=schema.sql --yes && npx wrangler deploy
```
