...
<head>
  ...
  <style>
    ...
    *{box-sizing:border-box;}
    ...
    .idle-or{margin:36px 0 0 0;font-size:13px;font-weight:800;color:var(--muted);letter-spacing:4px;text-transform:uppercase;display:flex;align-items:center;justify-content:center;gap:14px;}
    .idle-or::before,.idle-or::after{content:'';flex:0 0 60px;height:1px;background:var(--line);}
    .idle-qr-cap{margin:14px 0 0 0;font-size:16px;color:var(--text);font-weight:600;line-height:1.4;}
    .idle-qr-box{margin:14px auto 0 auto;display:inline-block;background:#fff;padding:14px;border-radius:14px;box-shadow:0 4px 16px rgba(17,24,39,0.10);border:1px solid var(--line);}
    .idle-qr-box svg{display:block;width:180px;height:180px;}
...
<body>
  <div class="wrap">
    ...
    <!-- Main -->
    <div class="card main">
      <!-- Telemedicine evening banner — appears 8pm to midnight (Malta).
           Doesn't disrupt the regular booking flow: regular slots and
           next-day options still render below. -->
      <div id="telemedicineBanner" style="display:none;background:linear-gradient(135deg,#fff7ed 0%,#ffedd5 100%);border:2px solid #f97316;border-radius:14px;padding:16px 18px;margin-bottom:14px;">
        <div style="display:flex;align-items:flex-start;gap:12px;flex-wrap:wrap;">
          <div style="flex:1;min-width:220px;">
            ...
            <div style="color:#7c2d12;font-size:14px;line-height:1.5;">
              Book a telemedicine call between <b>8pm and midnight</b>. The doctor calls you on your phone.
          ...
          <button type="button" id="telemedicineBookBtn" onclick="openTelemedicineModal()" style="flex-shrink:0;padding:14px 22px;border:none;border-radius:12px;background:#ea580c;color:#fff;font-weight:800;font-size:15px;cursor:pointer;box-shadow:0 2px 8px rgba(234,88,12,.30);">Book Telemedicine — €25</button>
        </div>
      </div>
  ...
  <div class="idle-overlay" id="idleOverlay">
    <div class="idle-card">
      <!-- Telemedicine evening notice on the splash. Hidden outside 8pm–midnight. -->
      <div id="splashTelemedNotice" style="display:none;background:#fff7ed;border:2px solid #f97316;border-radius:14px;padding:14px 18px;margin-bottom:18px;text-align:center;">
        ...
        <div style="color:#7c2d12;font-size:14px;margin-top:4px;">Tap to book a phone consultation — flat fee <b>€25</b>.</div>
      </div>
      ...
      <div class="idle-or">or</div>
      <div class="idle-qr-cap">Prefer to book later?<br>Scan with your phone to book from home.</div>
      <div class="idle-qr-box">
        <svg viewBox="0 0 33 33" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="QR code: kevappts.labrint.workers.dev">
          <path fill="#000" d="M2,2H3V3H2zM3,2H4V3H3zM4,2H5V3H4zM5,2H6V3H5zM6,2H7V3H6zM7,2H8V3H7zM8,2H9V3H8zM13,2H14V3H13zM15,2H16V3H15zM19,2H20V3H19zM20,2H21V3H20zM21,2H22V3H21zM22,2H23V3H22zM24,2H25V3H24zM25,2H26V3H25zM26,2H27V3H26zM27,2H28V3H27zM28,2H29V3H28zM29,2H30V3H29zM30,2H31V3H30zM2,3H3V4H2zM8,3H9V4H8zM11,3H12V4H11zM15,3H16V4H15zM16,3H17V4H16zM17,3H18V4H17zM19,3H20V4H19zM22,3H23V4H22zM24,3H25V4H24zM30,3H31V4H30zM2,4H3V5H2zM4,4H5V5H4zM5,4H6V5H5zM6,4H7V5H6zM8,4H9V5H8zM10,4H11V5H10zM11,4H12V5H11zM12,4H13V5H12zM16,4H17V5H16zM18,4H19V5H18zM20,4H21V5H20zM24,4H25V5H24zM26,4H27V5H26zM27,4H28V5H27zM28,4H29V5H28zM30,4H31V5H30zM2,5H3V6H2zM4,5H5V6H4zM5,5H6V6H5zM6,5H7V6H6zM8,5H9V6H8zM10,5H11V6H10zM11,5H12V6H11zM13,5H14V6H13zM17,5H18V6H17zM18,5H19V6H18zM19,5H20V6H19zM21,5H22V6H21zM24,5H25V6H24zM26,5H27V6H26zM27,5H28V6H27zM28,5H29V6H28zM30,5H31V6H30zM2,6H3V7H2zM4,6H5V7H4zM5,6H6V7H5zM6,6H7V7H6zM8,6H9V7H8zM10,6H11V7H10zM12,6H13V7H12zM13,6H14V7H13zM15,6H16V7H15zM18,6H19V7H18zM21,6H22V7H21zM22,6H23V7H22zM24,6H25V7H24zM26,6H27V7H26zM27,6H28V7H27zM28,6H29V7H28zM30,6H31V7H30zM2,7H3V8H2zM8,7H9V8H8zM10,7H11V8H10zM12,7H13V8H12zM15,7H16V8H15zM16,7H17V8H16zM17,7H18V8H17zM18,7H19V8H18zM24,7H25V8H24zM30,7H31V8H30zM2,8H3V9H2zM3,8H4V9H3zM4,8H5V9H4zM5,8H6V9H5zM6,8H7V9H6zM7,8H8V9H7zM8,8H9V9H8zM10,8H11V9H10zM12,8H13V9H12zM14,8H15V9H14zM16,8H17V9H16zM18,8H19V9H18zM20,8H21V9H20zM22,8H23V9H22zM24,8H25V9H24zM25,8H26V9H25zM26,8H27V9H26zM27,8H28V9H27zM28,8H29V9H28zM29,8H30V9H29zM30,8H31V9H30zM10,9H11V10H10zM14,9H15V10H14zM15,9H16V10H15zM17,9H18V10H17zM18,9H19V10H18zM20,9H21V10H20zM21,9H22V10H21zM2,10H3V11H2zM4,10H5V11H4zM5,10H6V11H5zM6,10H7V11H6zM7,10H8V11H7zM8,10H9V11H8zM12,10H13V11H12zM16,10H17V11H16zM17,10H18V11H17zM19,10H20V11H19zM20,10H21V11H20zM22,10H23V11H22zM24,10H25V11H24zM25,10H26V11H25zM26,10H27V11H26zM27,10H28V11H27zM28,10H29V11H28zM3,11H4V12H3zM4,11H5V12H4zM5,11H6V12H5zM6,11H7V12H6zM7,11H8V12H7zM11,11H12V12H11zM12,11H13V12H12zM18,11H19V12H18zM19,11H20V12H19zM20,11H21V12H20zM21,11H22V12H21zM22,11H23V12H22zM24,11H25V12H24zM25,11H26V12H25zM26,11H27V12H26zM30,11H31V12H30zM2,12H3V13H2zM3,12H4V13H3zM6,12H7V13H6zM7,12H8V13H7zM8,12H9V13H8zM11,12H12V13H11zM13,12H14V13H13zM14,12H15V13H14zM17,12H18V13H17zM19,12H20V13H19zM23,12H24V13H23zM25,12H26V13H25zM26,12H27V13H26zM2,13H3V14H2zM6,13H7V14H6zM7,13H8V14H7zM9,13H10V14H9zM16,13H17V14H16zM17,13H18V14H17zM18,13H19V14H18zM20,13H21V14H20zM21,13H22V14H21zM23,13H24V14H23zM26,13H27V14H26zM27,13H28V14H27zM29,13H30V14H29zM3,14H4V15H3zM4,14H5V15H4zM5,14H6V15H5zM6,14H7V15H6zM8,14H9V15H8zM10,14H11V15H10zM11,14H12V15H11zM12,14H13V15H12zM13,14H14V15H13zM17,14H18V15H17zM19,14H20V15H19zM27,14H28V15H27zM28,14H29V15H28zM6,15H7V16H6zM7,15H8V16H7zM9,15H10V16H9zM10,15H11V16H10zM11,15H12V16H11zM12,15H13V16H12zM13,15H14V16H13zM14,15H15V16H14zM15,15H16V16H15zM16,15H17V16H16zM18,15H19V16H18zM21,15H22V16H21zM22,15H23V16H22zM24,15H25V16H24zM25,15H26V16H25zM26,15H27V16H26zM30,15H31V16H30zM2,16H3V17H2zM3,16H4V17H3zM7,16H8V17H7zM8,16H9V17H8zM9,16H10V17H9zM11,16H12V17H11zM12,16H13V17H12zM13,16H14V17H13zM14,16H15V17H14zM15,16H16V17H15zM16,16H17V17H16zM17,16H18V17H17zM19,16H20V17H19zM22,16H23V17H22zM23,16H24V17H23zM27,16H28V17H27zM28,16H29V17H28zM5,17H6V18H5zM6,17H7V18H6zM7,17H8V18H7zM11,17H12V18H11zM14,17H15V18H14zM15,17H16V18H15zM18,17H19V18H18zM23,17H24V18H23zM25,17H26V18H25zM26,17H27V18H26zM29,17H30V18H29zM3,18H4V19H3zM6,18H7V19H6zM7,18H8V19H7zM8,18H9V19H8zM12,18H13V19H12zM14,18H15V19H14zM16,18H17V19H16zM19,18H20V19H19zM25,18H26V19H25zM27,18H28V19H27zM28,18H29V19H28zM2,19H3V20H2zM3,19H4V20H3zM4,19H5V20H4zM7,19H8V20H7zM11,19H12V20H11zM13,19H14V20H13zM14,19H15V20H14zM19,19H20V20H19zM20,19H21V20H20zM21,19H22V20H21zM22,19H23V20H22zM24,19H25V20H24zM25,19H26V20H25zM26,19H27V20H26zM28,19H29V20H28zM30,19H31V20H30zM2,20H3V21H2zM4,20H5V21H4zM5,20H6V21H5zM6,20H7V21H6zM8,20H9V21H8zM11,20H12V21H11zM13,20H14V21H13zM17,20H18V21H17zM18,20H19V21H18zM19,20H20V21H19zM25,20H26V21H25zM26,20H27V21H26zM28,20H29V21H28zM2,21H3V22H2zM10,21H11V22H10zM11,21H12V22H11zM16,21H17V22H16zM22,21H23V22H22zM23,21H24V22H23zM25,21H26V22H25zM26,21H27V22H26zM29,21H30V22H29zM2,22H3V23H2zM6,22H7V23H6zM7,22H8V23H7zM8,22H9V23H8zM11,22H12V23H11zM13,22H14V23H13zM17,22H18V23H17zM18,22H19V23H18zM19,22H20V23H19zM21,22H22V23H21zM22,22H23V23H22zM23,22H24V23H23zM24,22H25V23H24zM25,22H26V23H25zM26,22H27V23H26zM28,22H29V23H28zM29,22H30V23H29zM30,22H31V23H30zM10,23H11V24H10zM11,23H12V24H11zM14,23H15V24H14zM15,23H16V24H15zM16,23H17V24H16zM18,23H19V24H18zM22,23H23V24H22zM26,23H27V24H26zM27,23H28V24H27zM28,23H29V24H28zM29,23H30V24H29zM30,23H31V24H30zM2,24H3V25H2zM3,24H4V25H3zM4,24H5V25H4zM5,24H6V25H5zM6,24H7V25H6zM7,24H8V25H7zM8,24H9V25H8zM11,24H12V25H11zM13,24H14V25H13zM15,24H16V25H15zM16,24H17V25H16zM17,24H18V25H17zM19,24H20V25H19zM20,24H21V25H20zM21,24H22V25H21zM22,24H23V25H22zM24,24H25V25H24zM26,24H27V25H26zM27,24H28V25H27zM28,24H29V25H28zM2,25H3V26H2zM8,25H9V26H8zM10,25H11V26H10zM13,25H14V26H13zM14,25H15V26H14zM15,25H16V26H15zM20,25H21V26H20zM21,25H22V26H21zM22,25H23V26H22zM26,25H27V26H26zM2,26H3V27H2zM4,26H5V27H4zM5,26H6V27H5zM6,26H7V27H6zM8,26H9V27H8zM10,26H11V27H10zM11,26H12V27H11zM12,26H13V27H12zM13,26H14V27H13zM16,26H17V27H16zM17,26H18V27H17zM18,26H19V27H18zM19,26H20V27H19zM22,26H23V27H22zM23,26H24V27H23zM24,26H25V27H24zM25,26H26V27H25zM26,26H27V27H26zM28,26H29V27H28zM2,27H3V28H2zM4,27H5V28H4zM5,27H6V28H5zM6,27H7V28H6zM8,27H9V28H8zM10,27H11V28H10zM11,27H12V28H11zM13,27H14V28H13zM14,27H15V28H14zM15,27H16V28H15zM18,27H19V28H18zM19,27H20V28H19zM20,27H21V28H20zM22,27H23V28H22zM27,27H28V28H27zM28,27H29V28H28zM29,27H30V28H29zM30,27H31V28H30zM2,28H3V29H2zM4,28H5V29H4zM5,28H6V29H5zM6,28H7V29H6zM8,28H9V29H8zM10,28H11V29H10zM11,28H12V29H11zM15,28H16V29H15zM17,28H18V29H17zM18,28H19V29H18zM19,28H20V29H19zM20,28H21V29H20zM21,28H22V29H21zM22,28H23V29H22zM24,28H25V29H24zM25,28H26V29H25zM26,28H27V29H26zM27,28H28V29H27zM28,28H29V29H28zM29,28H30V29H29zM2,29H3V30H2zM8,29H9V30H8zM11,29H12V30H11zM12,29H13V30H12zM15,29H16V30H15zM17,29H18V30H17zM18,29H19V30H18zM22,29H23V30H22zM23,29H24V30H23zM25,29H26V30H25zM27,29H28V30H27zM29,29H30V30H29zM2,30H3V31H2zM3,30H4V31H3zM4,30H5V31H4zM5,30H6V31H5zM6,30H7V31H6zM7,30H8V31H7zM8,30H9V31H8zM10,30H11V31H10zM13,30H14V31H13zM16,30H17V31H16zM17,30H18V31H17zM19,30H20V31H19zM24,30H25V31H24zM28,30H29V31H28z"/>
        </svg>
      </div>
    </div>
  </div>
  ...
  <div class="overlay" id="telemedicineOverlay" role="dialog" aria-modal="true">
    <div class="modal" style="max-width:460px;">
      ...
      <div style="display:flex;flex-direction:column;gap:10px;">
        <div>
          <label class="label" for="telemedName">Full name *</label>
          <input id="telemedName" type="text" autocomplete="name" placeholder="Full name">
        </div>
        <div>
          <label class="label" for="telemedPhone">Phone *</label>
          <input id="telemedPhone" type="tel" autocomplete="tel" placeholder="+356 ...">
        </div>
        <div>
          <label class="label" for="telemedEmail">Email *</label>
          <input id="telemedEmail" type="email" autocomplete="email" placeholder="you@example.com">
        </div>
        <div>
          <label class="label" for="telemedComments">Comments (optional)</label>
          <textarea id="telemedComments" placeholder="Briefly, what would you like to discuss with the doctor?" rows="2"></textarea>
        </div>
        <div id="telemedError" class="field-error"></div>
      </div>
  ...
  <script>
    ...
    TR.en = {
      ...
      noSlots:'No slots available.',noDates:'No available dates in the next 7 days.',noSlotsToday:'No more appointments available today.',noSlotsTodayShowingDate:'Showing {date} instead. Please pick a time below.',choiceMorningFull:"Morning slots are full at Potter's",choiceMorningFullSub:"You can see Dr James at Spinola Clinic now, or wait for Potter's later slots.",choiceEarlier:'Spinola Clinic is open earlier today!',choiceEarlierSub:"Dr James at Spinola is available from {time1}. Potter's Pharmacy Clinic opens at {time2}.",choiceBtnSpinola:'See Spinola Slots (from {time})',choiceBtnPotters:"See Potter's Slots (from {time})",
    ...
    TR.fr = {
      ...
      noSlots:'Aucun créneau disponible.',noDates:'Aucune date disponible dans les 7 prochains jours.',noSlotsToday:"Plus de rendez-vous disponibles aujourd'hui.",noSlotsTodayShowingDate:'Affichage du {date}. Veuillez choisir un horaire ci-dessous.',choiceMorningFull:"Les créneaux du matin sont complets chez Potter's",choiceMorningFullSub:"Vous pouvez voir Dr James à la Clinique Spinola maintenant, ou attendre les créneaux suivants chez Potter's.",choiceEarlier:"La Clinique Spinola ouvre plus tôt aujourd'hui !",choiceEarlierSub:"Dr James à Spinola est disponible dès {time1}. Potter's Pharmacy Clinic ouvre à {time2}.",choiceBtnSpinola:'Voir les créneaux Spinola (dès {time})',choiceBtnPotters:"Voir les créneaux Potter's (dès {time})",
    ...
    TR.es = {
      ...
      noSlots:'No hay turnos disponibles.',noDates:'No hay fechas disponibles en los próximos 7 días.',noSlotsToday:'No hay más citas disponibles hoy.',noSlotsTodayShowingDate:'Mostrando {date}. Por favor elija un horario abajo.',choiceMorningFull:"Los turnos de la mañana están llenos en Potter's",choiceMorningFullSub:"Puede ver al Dr James en la Clínica Spinola ahora, o esperar los turnos posteriores de Potter's.",choiceEarlier:'¡La Clínica Spinola abre más temprano hoy!',choiceEarlierSub:"Dr James en Spinola está disponible desde las {time1}. Potter's Pharmacy Clinic abre a las {time2}.",choiceBtnSpinola:'Ver turnos de Spinola (desde {time})',choiceBtnPotters:"Ver turnos de Potter's (desde {time})",
    ...
    TR.it = {
      ...
      noSlots:'Nessuno slot disponibile.',noDates:'Nessuna data disponibile nei prossimi 7 giorni.',noSlotsToday:'Nessun appuntamento disponibile oggi.',noSlotsTodayShowingDate:'Mostrando {date}. Scegli un orario qui sotto.',choiceMorningFull:"I posti del mattino sono esauriti da Potter's",choiceMorningFullSub:"Puoi vedere il Dr James alla Clinica Spinola ora, o aspettare gli orari successivi di Potter's.",choiceEarlier:'La Clinica Spinola apre prima oggi!',choiceEarlierSub:"Dr James a Spinola è disponibile dalle {time1}. Potter's Pharmacy Clinic apre alle {time2}.",choiceBtnSpinola:'Vedi orari Spinola (dalle {time})',choiceBtnPotters:"Vedi orari Potter's (dalle {time})",
    ...
    TR.zh = {
      ...
      noSlots:'没有可用时段。',noDates:'未来7天没有可用日期。',noSlotsToday:'今天没有更多预约了。',noSlotsTodayShowingDate:'显示{date}。请在下方选择时间。',choiceMorningFull:"Potter's诊所上午已满",choiceMorningFullSub:"您可以现在去Spinola诊所看James医生，或等待Potter' s的晚些时段。",choiceEarlier:'Spinola诊所今天开门更早！',choiceEarlierSub:"Spinola的James医生从{time1}开始接诊。Potter's Pharmacy Clinic从{time2}开始。",choiceBtnSpinola:'查看Spinola时段（从{time}起）',choiceBtnPotters:"查看Potter's时段（从{time}起）",
    ...
    TR.hi = {
      ...
      noSlots:'कोई स्लॉट उपलब्ध नहीं।',noDates:'अगले 7 दिनों में कोई तारीख उपलब्ध नहीं।',noSlotsToday:'आज कोई और अपॉइंटमेंट उपलब्ध नहीं है।',noSlotsTodayShowingDate:'{date} दिखा रहे हैं। कृपया नीचे समय चुनें।',choiceMorningFull:"Potter's में सुबह के स्लॉट भरे हैं",choiceMorningFullSub:"आप अभी Spinola Clinic में Dr James से मिल सकते हैं, या Potter's के बाद के स्लॉट की प्रतीक्षा करें।",choiceEarlier:'Spinola Clinic आज पहले खुला है!',choiceEarlierSub:"Spinola में Dr James {time1} से उपलब्ध हैं। Potter's Pharmacy Clinic {time2} पर खुलता है।",choiceBtnSpinola:'Spinola स्लॉट देखें ({time} से)',choiceBtnPotters:"Potter's स्लॉट देखें ({time} से)",
    ...
    TR.pt = {
      ...
      noSlots:'Nenhum horário disponível.',noDates:'Nenhuma data disponível nos próximos 7 dias.',noSlotsToday:'Não há mais consultas disponíveis hoje.',noSlotsTodayShowingDate:'Mostrando {date}. Por favor escolha um horário abaixo.',choiceMorningFull:"Os horários da manhã estão esgotados no Potter's",choiceMorningFullSub:"Pode consultar o Dr James na Clínica Spinola agora, ou esperar pelos horários seguintes do Potter's.",choiceEarlier:'A Clínica Spinola abre mais cedo hoje!',choiceEarlierSub:"Dr James em Spinola está disponível a partir das {time1}. Potter's Pharmacy Clinic abre às {time2}.",choiceBtnSpinola:'Ver horários Spinola (a partir das {time})',choiceBtnPotters:"Ver horários Potter's (a partir das {time})",
    ...
    TR.ru = {
      ...
      noSlots:'Нет доступных слотов.',noDates:'Нет доступных дат в ближайшие 7 дней.',noSlotsToday:'Сегодня больше нет свободных записей.',noSlotsTodayShowingDate:'Показываем {date}. Выберите время ниже.',choiceMorningFull:"Утренние слоты в Potter's заполнены",choiceMorningFullSub:"Вы можете обратиться к Dr James в клинику Spinola сейчас или подождать более поздних слотов Potter's.",choiceEarlier:'Клиника Spinola открывается раньше сегодня!',choiceEarlierSub:"Dr James в Spinola принимает с {time1}. Potter's Pharmacy Clinic открывается в {time2}.",choiceBtnSpinola:'Слоты Spinola (с {time})',choiceBtnPotters:"Слоты Potter's (с {time})",
    ...
    TR.ja = {
      ...
      noSlots:'利用可能な時間枠がありません。',noDates:'7日間に利用可能な日付がありません。',noSlotsToday:'本日の予約は終了しました。',noSlotsTodayShowingDate:'{date}を表示中。下から時間をお選びください。',choiceMorningFull:"Potter'sの午前の枠は満席です",choiceMorningFullSub:"Spinolaクリニックのジェームズ医師に今すぐ診てもらうか、Potter'sの後の時間帯をお待ちください。",choiceEarlier:'Spinolaクリニックは今日早く開院します！',choiceEarlierSub:"Spinolaのジェームズ医師は{time1}から受付中。Potter's Pharmacy Clinicは{time2}開院。",choiceBtnSpinola:'Spinolaの枠を見る（{time}から）',choiceBtnPotters:"Potter'sの枠を見る（{time}から）",
    ...
    TR.pa = {
      ...
      noSlots:'ਕੋਈ ਸਲਾਟ ਉਪਲਬਧ ਨਹੀਂ।',noDates:'ਅਗਲੇ 7 ਦਿਨਾਂ ਵਿੱਚ ਕੋਈ ਤਾਰੀਖ ਉਪਲਬਧ ਨਹੀਂ।',noSlotsToday:'ਅੱਜ ਹੋਰ ਅਪੌਇੰਟਮੈਂਟ ਉਪਲਬਧ ਨਹੀਂ।',noSlotsTodayShowingDate:'{date} ਦਿਖਾ ਰਹੇ ਹਾਂ। ਕਿਰਪਾ ਕਰਕੇ ਹੇਠਾਂ ਸਮਾਂ ਚੁਣੋ।',choiceMorningFull:"Potter's ਵਿੱਚ ਸਵੇਰ ਦੇ ਸਲਾਟ ਭਰੇ ਹਨ",choiceMorningFullSub:'ਤੁਸੀਂ ਹੁਣੇ Spinola Clinic ਵਿੱਚ Dr James ਨੂੰ ਮਿਲ ਸਕਦੇ ਹੋ।',choiceEarlier:'Spinola Clinic ਅੱਜ ਪਹਿਲਾਂ ਖੁੱਲ੍ਹਾ ਹੈ!',choiceEarlierSub:"Spinola ਵਿੱਚ Dr James {time1} ਤੋਂ ਉਪਲਬਧ। Potter's {time2} ਤੇ ਖੁੱਲ੍ਹਦਾ ਹੈ।",choiceBtnSpinola:'Spinola ਸਲਾਟ ਵੇਖੋ ({time} ਤੋਂ)',choiceBtnPotters:"Potter's ਸਲਾਟ ਵੇਖੋ ({time} ਤੋਂ)",
    ...
    TR.tr = {
      ...
      noSlots:'Müsait saat yok.',noDates:'Önümüzdeki 7 günde müsait tarih yok.',noSlotsToday:'Bugün için randevu kalmadı.',noSlotsTodayShowingDate:'{date} gösteriliyor. Lütfen aşağıdan bir saat seçin.',choiceMorningFull:"Potter's sabah randevuları dolu",choiceMorningFullSub:"Şimdi Spinola Kliniği'nde Dr James'i görebilir veya Potter's'ın sonraki saatlerini bekleyebilirsiniz.",choiceEarlier:'Spinola Kliniği bugün daha erken açılıyor!',choiceEarlierSub:"Spinola'da Dr James {time1}'den itibaren müsait. Potter's Pharmacy Clinic {time2}'de açılıyor.",choiceBtnSpinola:'Spinola saatlerini gör ({time})',choiceBtnPotters:"Potter's saatlerini gör ({time})",
    ...
    TR.ar = {
      ...
      noSlots:'لا توجد أوقات متاحة.',noDates:'لا توجد تواريخ متاحة في الأيام السبعة القادمة.',noSlotsToday:'لا مواعيد متاحة اليوم.',noSlotsTodayShowingDate:'عرض {date}. يرجى اختيار وقت أدناه.',choiceMorningFull:"مواعيد الصباح ممتلئة في Potter's",choiceMorningFullSub:"يمكنك زيارة Dr James في عيادة Spinola الآن أو انتظار مواعيد Potter's اللاحقة.",choiceEarlier:'عيادة Spinola تفتح أبكر اليوم!',choiceEarlierSub:"Dr James في Spinola متاح من {time1}. Potter's Pharmacy Clinic يفتح في {time2}.",choiceBtnSpinola:'مواعيد Spinola (من {time})',choiceBtnPotters:"مواعيد Potter's (من {time})",
    ...
    TR.pl = {
      ...
      noSlots:'Brak dostępnych godzin.',noDates:'Brak dostępnych dat w najbliższych 7 dniach.',noSlotsToday:'Brak wolnych wizyt na dziś.',noSlotsTodayShowingDate:'Pokazujemy {date}. Proszę wybrać godzinę poniżej.',choiceMorningFull:"Poranne terminy w Potter's są zajęte",choiceMorningFullSub:"Możesz umówić się do Dr James w Klinice Spinola teraz lub poczekać na późniejsze terminy Potter's.",choiceEarlier:'Klinika Spinola otwiera się wcześniej dziś!',choiceEarlierSub:"Dr James w Spinola przyjmuje od {time1}. Potter's Pharmacy Clinic otwiera się o {time2}.",choiceBtnSpinola:'Terminy Spinola (od {time})',choiceBtnPotters:"Terminy Potter's (od {time})",
    ...
    TR.sr = {
      ...
      noSlots:'Nema dostupnih termina.',noDates:'Nema dostupnih datuma u narednih 7 dana.',noSlotsToday:'Nema više termina za danas.',noSlotsTodayShowingDate:'Prikazujemo {date}. Izaberite vreme ispod.',choiceMorningFull:"Jutarnji termini u Potter's su popunjeni",choiceMorningFullSub:"Možete posetiti Dr James u Spinola klinici sada ili sačekati kasnija vremena u Potter's.",choiceEarlier:'Spinola klinika se otvara ranije danas!',choiceEarlierSub:"Dr James u Spinoli prima od {time1}. Potter's Pharmacy Clinic se otvara u {time2}.",choiceBtnSpinola:'Termini Spinola (od {time})',choiceBtnPotters:"Termini Potter's (od {time})",
    ...
    TR.hr = {
      ...
      confirmingTitle:'Potvrđivanje termina…',confirmingDesc:'Slanje e-maila za potvrdu.',
      noSlots:'Nema dostupnih termina.',noDates:'Nema dostupnih datuma u sljedećih 7 dana.',noSlotsToday:'Nema više termina za danas.',noSlotsTodayShowingDate:'Prikazujemo {date}. Odaberite vrijeme ispod.',choiceMorningFull:"Jutarnji termini u Potter's su popunjeni",choiceMorningFullSub:"Možete posjetiti Dr James u Spinola klinici sada ili pričekati kasnija vremena u Potter's.",choiceEarlier:'Spinola klinika se otvara ranije danas!',choiceEarlierSub:"Dr James u Spinoli prima od {time1}. Potter's Pharmacy Clinic se otvara u {time2}.",choiceBtnSpinola:'Termini Spinola (od {time})',choiceBtnPotters:"Termini Potter's (od {time})",
    ...
    TR.uk = {
      ...
      noSlots:'Немає доступних слотів.',noDates:'Немає доступних дат у наступні 7 днів.',noSlotsToday:'Сьогодні більше немає записів.',noSlotsTodayShowingDate:'Показуємо {date}. Оберіть час нижче.',choiceMorningFull:"Ранкові слоти в Potter's зайняті",choiceMorningFullSub:"Ви можете звернутися до Dr James у клініку Spinola зараз або зачекати пізніших слотів Potter's.",choiceEarlier:'Клініка Spinola відкривається раніше сьогодні!',choiceEarlierSub:"Dr James у Spinola приймає з {time1}. Potter's Pharmacy Clinic відкривається о {time2}.",choiceBtnSpinola:'Слоти Spinola (з {time})',choiceBtnPotters:"Слоти Potter's (з {time})",
    ...
    TR.fil = {
      ...
      noSlots:'Walang available na slot.',noDates:'Walang available na petsa sa susunod na 7 araw.',noSlotsToday:'Wala nang available na appointment ngayon.',noSlotsTodayShowingDate:'Ipinapakita ang {date}. Pumili ng oras sa ibaba.',choiceMorningFull:"Puno na ang morning slots sa Potter's",choiceMorningFullSub:"Maaari kang magpa-check up kay Dr James sa Spinola Clinic ngayon o maghintay ng mga susunod na slot sa Potter's.",choiceEarlier:'Mas maaga bukas ang Spinola Clinic ngayon!',choiceEarlierSub:"Si Dr James sa Spinola ay available mula {time1}. Potter's Pharmacy Clinic bukas sa {time2}.",choiceBtnSpinola:'Tingnan ang Spinola Slots (mula {time})',choiceBtnPotters:"Tingnan ang Potter's Slots (mula {time})",
    ...
    TR.bg = {
      ...
      noSlots:'Няма налични часове.',noDates:'Няма налични дати в следващите 7 дни.',noSlotsToday:'Няма повече часове за днес.',noSlotsTodayShowingDate:'Показваме {date}. Моля изберете час по-долу.',choiceMorningFull:"Сутрешните часове в Potter's са заети",choiceMorningFullSub:"Можете да посетите Dr James в клиника Spinola сега или да изчакате по-късните часове на Potter's.",choiceEarlier:'Клиника Spinola отваря по-рано днес!',choiceEarlierSub:"Dr James в Spinola приема от {time1}. Potter's Pharmacy Clinic отваря в {time2}.",choiceBtnSpinola:'Часове Spinola (от {time})',choiceBtnPotters:"Часове Potter's (от {time})",
    ...
    TR.ro = {
      ...
      noSlots:'Nu sunt ore disponibile.',noDates:'Nu sunt date disponibile în următoarele 7 zile.',noSlotsToday:'Nu mai sunt programări disponibile astăzi.',noSlotsTodayShowingDate:'Afișăm {date}. Vă rugăm alegeți o oră mai jos.',choiceMorningFull:"Programările de dimineață la Potter's sunt pline",choiceMorningFullSub:"Puteți consulta Dr James la Clinica Spinola acum sau așteptați orele ulterioare de la Potter's.",choiceEarlier:'Clinica Spinola deschide mai devreme astăzi!',choiceEarlierSub:"Dr James la Spinola este disponibil de la {time1}. Potter's Pharmacy Clinic deschide la {time2}.",choiceBtnSpinola:'Ore Spinola (de la {time})',choiceBtnPotters:"Ore Potter's (de la {time})",
    ...
    TR.lt = {
      ...
      noSlots:'Laisvų laikų nėra.',noDates:'Artimiausiomis 7 dienomis laisvų datų nėra.',noSlotsToday:'Šiandien daugiau laisvų laikų nėra.',noSlotsTodayShowingDate:'Rodome {date}. Pasirinkite laiką žemiau.',choiceMorningFull:"Ryto laikai Potter's užimti",choiceMorningFullSub:"Galite apsilankyti pas Dr James Spinola klinikoje dabar arba palaukti vėlesnių Potter's laikų.",choiceEarlier:'Spinola klinika šiandien atsidaro anksčiau!',choiceEarlierSub:"Dr James Spinoloje priima nuo {time1}. Potter's Pharmacy Clinic atsidaro {time2}.",choiceBtnSpinola:'Spinola laikai (nuo {time})',choiceBtnPotters:"Potter's laikai (nuo {time})",
    ...
    TR.mt = {
      ...
      noSlots:"M'hemm l-ebda slot disponibbli.",noDates:"M'hemmx dati disponibbli fis-7 ijiem li \u0121ejjin.",noSlotsToday:"M'hemmx aktar appuntamenti disponibbli llum.",noSlotsTodayShowingDate:"Qed nuru {date}. Jekk jog\u0127\u0121bok ag\u0127\u017cel \u0127in hawn ta\u0127t.",choiceMorningFull:"Is-slots tal-g\u0127odwa f'Potter's huma mimlijin",choiceMorningFullSub:"Tista' tara lil Dr James fil-Klinika Spinola issa, jew tistenna g\u0127all-\u0127inijiet ta' wara ta' Potter's.",choiceEarlier:"Il-Klinika Spinola tifta\u0127 aktar kmieni llum!",choiceEarlierSub:"Dr James f'Spinola huwa disponibbli minn {time1}. Potter's Pharmacy Clinic tifta\u0127 fil-{time2}.",choiceBtnSpinola:"Ara s-slots ta' Spinola (minn {time})",choiceBtnPotters:"Ara s-slots ta' Potter's (minn {time})",
    ...
    function showChoiceBanner(pottersSlots, spinolaRes) {
      ...
      if (_bs) _bs.textContent = spinolaEarliest ? t('choiceBtnSpinola').replace('{time}', to12h(spinolaEarliest.start)) : t('choiceBtnSpinola').replace(' (from {time})', '');
      if (_bp) _bp.textContent = pottersEarliest ? t('choiceBtnPotters').replace('{time}', to12h(pottersEarliest.start)) : t('choiceBtnPotters').replace(' (from {time})', '');
    }
    ...
    function showChoiceBannerEarly(pottersSlots, spinolaRes, spinolaTime, pottersTime) {
      ...
      if (subEl) subEl.innerHTML = t('choiceEarlierSub').replace('{time1}', '<b>' + to12h(spinolaTime) + '</b>').replace('{time2}', '<b>' + to12h(pottersTime) + '</b>');
    ...
    // ─── Telemedicine (8pm–midnight) ─────────────────────────
    // Polls /api/telemedicine/status to know if the evening window is open
    // and shows banners on both the booking page and splash. Booking the
    // call is a one-shot POST to /api/book-telemedicine; never touches the
    // regular slot booking flow above.
    var _telemedicineOpen = false;
    function refreshTelemedicineStatus() {
      try {
        fetch('/api/telemedicine/status').then(function(r){ return r.json(); }).then(function(data){
          if (!data || !data.ok) return;
          _telemedicineOpen = !!data.open;
          var banner = document.getElementById('telemedicineBanner');
          if (banner) banner.style.display = _telemedicineOpen ? 'block' : 'none';
          var splash = document.getElementById('splashTelemedNotice');
          if (splash) splash.style.display = _telemedicineOpen ? 'block' : 'none';
        }).catch(function(){});
      } catch (e) {}
    }
    refreshTelemedicineStatus();
    // Re-check every 60s so the banner appears at 8pm without a reload, and
    ...
    function openTelemedicineModal() {
      ...
      if (phoneEl && phoneEl.value) {
        ...
        document.getElementById('telemedPhone').value = (dial ? dial + ' ' : '') + phoneEl.value;
      }
    ...
    async function submitTelemedicineCall() {
      ...
      var err = document.getElementById('telemedError');
      err.textContent = '';
      var name = document.getElementById('telemedName').value.trim();
      var phone = document.getElementById('telemedPhone').value.trim();
      var email = document.getElementById('telemedEmail').value.trim();
      var comments = document.getElementById('telemedComments').value.trim();
      if (!name) { err.textContent = 'Please enter your full name.'; return; }
      if (!phone) { err.textContent = 'Please enter a phone number we can call.'; return; }
      if (!email) { err.textContent = 'Please enter an email so we can confirm your call.'; return; }
      btn.disabled = true; btn.textContent = 'Booking…';
      try {
        var res = await fetch('/api/book-telemedicine', {
          method: 'POST',
          headers: { 'Content-Type': 'application/json' },
          body: JSON.stringify({ fullName: name, phone: phone, email: email, comments: comments }),
        });
        ...
        btn.disabled = false; btn.textContent = 'Book Call — €25';
      }
    }
    // Expose for inline onclick handlers above
