...
<body>
  ...
  <script>
    ...
    TR.mt = {
      ...
      noSlots:'M\\'hemm l-ebda slot disponibbli.',noDates:'M\\',noSlotsToday:'M\'hemmx aktar appuntamenti disponibbli llum.',noSlotsTodayShowingDate:'Qed nuru {date}. Jekk jogħġbok agħżel ħin hawn taħt.',choiceMorningFull:'Is-slots tal-għodwa f\'Potter\'s huma mimlijin',choiceMorningFullSub:'Tista\' tara lil Dr James fil-Klinika Spinola issa, jew tistenna għall-ħinijiet ta\' wara ta\' Potter\'s.',choiceEarlier:'Il-Klinika Spinola tiftaħ aktar kmieni llum!',choiceEarlierSub:'Dr James f\'Spinola huwa disponibbli minn {time1}. Potter\'s Pharmacy Clinic tiftaħ fil-{time2}.',choiceBtnSpinola:'Ara s-slots ta\' Spinola (minn {time})',choiceBtnPotters:'Ara s-slots ta\' Potter\'s (minn {time})',hemmx dati disponibbli fis-7 ijiem li ġejjin.',
