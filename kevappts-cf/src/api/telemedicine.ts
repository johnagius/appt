...
async function doInsertCall(env: Env, opts: {
  ...
  return json({
    ...
    message: "Telemedicine booking confirmed. All telemedicine calls require you to be at Potter's Pharmacy. The pharmacist will contact the doctor via video call following this booking. Fee: €25 (paid to the doctor on the call).",
  });
}
