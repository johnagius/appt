...
-- Splash-page toggles (mutually exclusive; '1' = show that splash instead of
-- the booking page). DOCTOR_UNAVAILABLE = doctor-away / go-to-Spinola splash.
-- REVIEW_SPLASH = ask visitors to leave a Google review.
INSERT OR IGNORE INTO config (key, value) VALUES ('DOCTOR_UNAVAILABLE', '0');
INSERT OR IGNORE INTO config (key, value) VALUES ('REVIEW_SPLASH', '0');
