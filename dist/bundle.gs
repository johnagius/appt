    ...
    <div class="card main">
      ...
      <div class="row">
        ...
        <div style="flex: 1 1 220px;">
          ...
          <div class="phoneWrap">
            <select id="countryCode" aria-label="Country code"></select>
  ...
  <script>
    ...
    (function initCountrySelect(){
      COUNTRIES.forEach((c, i) => {
        ...
        o.value = i;
        o.textContent = c.flag;
        o.title = c.name + ' ' + c.code;
        els.countryCode.appendChild(o);
      });
      els.countryCode.value = '0'; // Malta default
      els.dialCode.textContent = COUNTRIES[0].code;
      els.countryCode.addEventListener('change', () => {
        const c = COUNTRIES[els.countryCode.value];
    ...
    function getFullPhone() {
      const c = COUNTRIES[els.countryCode.value];
      const local = els.phone.value.trim().replace(/^0+/, '');
      return c.code + local;
    }
